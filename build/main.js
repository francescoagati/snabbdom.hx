...
snabbdom_Main.main = function() {
	...
	snabbdom_Patch.patch(container,vnode);
	var last_node = vnode;
	...
	timer.run = function() {
		...
		var vnode2 = { sel : "div", data : { attrs : { id : "pippa"}}, children : [{ sel : "ul", data : { attrs : { }, style : { fontSize : "30px", color : color, backgroundColor : bg}}, children : [{ sel : "li", data : { attrs : { }}, children : null, elm : null, key : null, text : "1"},{ sel : "li", data : { attrs : { }}, children : null, elm : null, key : null, text : "2"},{ sel : "li", data : { attrs : { }}, children : null, elm : null, key : null, text : "3"},{ sel : "li", data : { attrs : { }}, children : null, elm : null, key : null, text : "2"},{ sel : "li", data : { attrs : { }}, children : null, elm : null, key : null, text : "5"},{ sel : "li", data : { attrs : { }}, children : [{ sel : "span", data : { attrs : { }}, children : null, elm : null, key : null, text : rnd}], elm : null, key : null, text : null}], elm : null, key : null, text : null}], elm : null, key : null, text : null};
		snabbdom_Patch.patch(last_node,vnode2);
		last_node = vnode2;
	};
};
var snabbdom_Attributes = function() { };
...
snabbdom_Patch.createElm = function(vnode,insertedVnodeQueue) {
	...
	if(sel != undefined) {
		...
		while(_g < _g1.length) {
			...
			old = oldAttrs[key1];
			if(old != cur) {
				if(!cur && snabbdom_Attributes.booleanAttrsDict[key1]) elm1.removeAttribute(key1); else elm1.setAttribute(key1,cur);
			}
		}
		var _g2 = 0;
						...
						new_node = (function($this) {
							...
							if(sel != undefined) {
								...
								while(_g6 < _g15.length) {
									...
									old2 = oldAttrs1[key6];
									if(old2 != cur4) {
										if(!cur4 && snabbdom_Attributes.booleanAttrsDict[key6]) elm6.removeAttribute(key6); else elm6.setAttribute(key6,cur4);
									}
								}
								var _g7 = 0;
					...
					if(startIdx1 <= endIdx1) do {
						...
						if(ch1 != undefined) {
							if(ch1.sel != undefined) {
								...
								if((i7 = ch1.data) != undefined && (i7 = i7.hook) != undefined && (i7 = i7.remove) != undefined) i7(ch1,rm); else rm();
		...
		if(oldVnode2 == vnode4) null; else {
			if(vnode4.data != undefined) {
				...
				while(_g24 < _g112.length) {
					...
					if(old4 != cur8) {
						if(!cur8 && snabbdom_Attributes.booleanAttrsDict[key11]) elm13.removeAttribute(key11); else elm13.setAttribute(key11,cur8);
					}
				}
				var _g25 = 0;
					...
					if(startIdx2 <= endIdx2) do {
						new_node2 = (function($this) {
							...
							if(sel1 != undefined) {
								...
								elm17 = vnode5.elm = data1 != undefined && (i15 = data1.ns) != undefined?document.createElementNS(i15,tag1):document.createElement(tag1);
								...
								while(_g30 < _g117.length) {
									...
									if(old6 != cur12) {
										if(!cur12 && snabbdom_Attributes.booleanAttrsDict[key16]) elm18.removeAttribute(key16); else elm18.setAttribute(key16,cur12);
									}
								}
								var _g34 = 0;
					...
					if(startIdx3 <= endIdx3) do {
						...
						if(ch3 != undefined) {
							if(ch3.sel != undefined) {
								...
								if((i18 = ch3.data) != undefined && (i18 = i18.hook) != undefined && (i18 = i18.remove) != undefined) i18(ch3,rm3); else rm3();
		...
		if(oldVnode4 == vnode8) null; else {
			if(vnode8.data != undefined) {
				...
				while(_g41 < _g124.length) {
					...
					if(old8 != cur16) {
						if(!cur16 && snabbdom_Attributes.booleanAttrsDict[key21]) elm25.removeAttribute(key21); else elm25.setAttribute(key21,cur16);
					}
				}
				var _g42 = 0;
					...
					if(startIdx4 <= endIdx4) do {
						new_node4 = (function($this) {
							...
							if(sel2 != undefined) {
								...
								elm29 = vnode9.elm = data2 != undefined && (i26 = data2.ns) != undefined?document.createElementNS(i26,tag2):document.createElement(tag2);
								...
								} else if(typeof vnode9.text == "string" || typeof vnode9.text == "number") elm29.appendChild(document.createTextNode(vnode9.text));
								...
								while(_g46 < _g129.length) {
									...
									if(old10 != cur20) {
										if(!cur20 && snabbdom_Attributes.booleanAttrsDict[key26]) elm30.removeAttribute(key26); else elm30.setAttribute(key26,cur20);
									}
								}
								var _g47 = 0;
							...
							} else elm29 = vnode9.elm = document.createTextNode(vnode9.text);
							$r = vnode9.elm;
							return $r;
						}(this));
					...
					if(startIdx5 <= endIdx5) do {
						...
						if(ch5 != undefined) {
							if(ch5.sel != undefined) {
								...
								if((i29 = ch5.data) != undefined && (i29 = i29.hook) != undefined && (i29 = i29.remove) != undefined) i29(ch5,rm6); else rm6();
		...
		if(oldVnode6 == vnode12) null; else {
			if(vnode12.data != undefined) {
				...
				while(_g53 < _g136.length) {
					...
					if(old12 != cur24) {
						if(!cur24 && snabbdom_Attributes.booleanAttrsDict[key31]) elm37.removeAttribute(key31); else elm37.setAttribute(key31,cur24);
					}
				}
				var _g54 = 0;
					...
					if(startIdx6 <= endIdx6) do {
						new_node6 = (function($this) {
							...
							if(sel3 != undefined) {
								...
								elm41 = vnode13.elm = data3 != undefined && (i37 = data3.ns) != undefined?document.createElementNS(i37,tag3):document.createElement(tag3);
								...
								} else if(typeof vnode13.text == "string" || typeof vnode13.text == "number") elm41.appendChild(document.createTextNode(vnode13.text));
								...
								while(_g58 < _g141.length) {
									...
									if(old14 != cur28) {
										if(!cur28 && snabbdom_Attributes.booleanAttrsDict[key36]) elm42.removeAttribute(key36); else elm42.setAttribute(key36,cur28);
									}
								}
								var _g59 = 0;
							...
							} else elm41 = vnode13.elm = document.createTextNode(vnode13.text);
							$r = vnode13.elm;
							return $r;
						}(this));
					...
					if(startIdx7 <= endIdx7) do {
						...
						if(ch7 != undefined) {
							if(ch7.sel != undefined) {
								...
								if((i40 = ch7.data) != undefined && (i40 = i40.hook) != undefined && (i40 = i40.remove) != undefined) i40(ch7,rm9); else rm9();
		...
		if(idxInOld == undefined) {
			var new_node9 = (function($this) {
				...
				if(sel4 != undefined) {
					...
					elm48 = vnode16.elm = data4 != undefined && (i45 = data4.ns) != undefined?document.createElementNS(i45,tag4):document.createElement(tag4);
					...
					} else if(typeof vnode16.text == "string" || typeof vnode16.text == "number") elm48.appendChild(document.createTextNode(vnode16.text));
					...
					while(_g65 < _g148.length) {
						...
						if(old16 != cur32) {
							if(!cur32 && snabbdom_Attributes.booleanAttrsDict[key42]) elm49.removeAttribute(key42); else elm49.setAttribute(key42,cur32);
						}
					}
					var _g66 = 0;
				...
				} else elm48 = vnode16.elm = document.createTextNode(vnode16.text);
				$r = vnode16.elm;
				return $r;
			}(this));
			...
			if(oldVnode9 == vnode17) null; else {
				if(vnode17.data != undefined) {
					...
					while(_g70 < _g153.length) {
						...
						if(old18 != cur36) {
							if(!cur36 && snabbdom_Attributes.booleanAttrsDict[key47]) elm54.removeAttribute(key47); else elm54.setAttribute(key47,cur36);
						}
					}
					var _g71 = 0;
						...
						if(startIdx8 <= endIdx8) do {
							new_node10 = (function($this) {
								...
								if(sel5 != undefined) {
									...
									elm58 = vnode18.elm = data5 != undefined && (i52 = data5.ns) != undefined?document.createElementNS(i52,tag5):document.createElement(tag5);
									...
									} else if(typeof vnode18.text == "string" || typeof vnode18.text == "number") elm58.appendChild(document.createTextNode(vnode18.text));
									...
									while(_g75 < _g158.length) {
										...
										if(old20 != cur40) {
											if(!cur40 && snabbdom_Attributes.booleanAttrsDict[key52]) elm59.removeAttribute(key52); else elm59.setAttribute(key52,cur40);
										}
									}
									var _g76 = 0;
								...
								} else elm58 = vnode18.elm = document.createTextNode(vnode18.text);
								$r = vnode18.elm;
								return $r;
							}(this));
						...
						if(startIdx9 <= endIdx9) do {
							...
							if(ch9 != undefined) {
								if(ch9.sel != undefined) {
									...
									if((i55 = ch9.data) != undefined && (i55 = i55.hook) != undefined && (i55 = i55.remove) != undefined) i55(ch9,rm12); else rm12();
	...
	if(oldStartIdx > oldEndIdx) {
		...
		if(startIdx10 <= newEndIdx) do {
			new_node12 = (function($this) {
				var $r;
				var vnode21 = vnodes10[startIdx10];
				var i60;
				...
				if(sel6 != undefined) {
					...
					elm65 = vnode21.elm = data6 != undefined && (i60 = data6.ns) != undefined?document.createElementNS(i60,tag6):document.createElement(tag6);
					...
					} else if(typeof vnode21.text == "string" || typeof vnode21.text == "number") elm65.appendChild(document.createTextNode(vnode21.text));
					...
					while(_g82 < _g165.length) {
						...
						if(old22 != cur44) {
							if(!cur44 && snabbdom_Attributes.booleanAttrsDict[key57]) elm66.removeAttribute(key57); else elm66.setAttribute(key57,cur44);
						}
					}
					var _g83 = 0;
				...
				} else elm65 = vnode21.elm = document.createTextNode(vnode21.text);
				$r = vnode21.elm;
				return $r;
			}(this));
		...
		if(startIdx11 <= oldEndIdx) do {
			...
			if(ch10 != undefined) {
				if(ch10.sel != undefined) {
					...
					if((i63 = ch10.data) != undefined && (i63 = i63.hook) != undefined && (i63 = i63.remove) != undefined) i63(ch10,rm15); else rm15();
...
snabbdom_Patch.patch = function(oldVnode,vnode) {
	...
	if(oldVnode instanceof Element) {
			...
			if(oldVnode2 == vnode2) null; else {
				if(vnode2.data != undefined) {
					...
					while(_g6 < _g15.length) {
						...
						old2 = oldAttrs1[key7];
						if(old2 != cur4) {
							if(!cur4 && snabbdom_Attributes.booleanAttrsDict[key7]) elm6.removeAttribute(key7); else elm6.setAttribute(key7,cur4);
						}
					}
					var _g7 = 0;
					var _g16 = Object.keys(oldAttrs1);
							...
							new_node1 = (function($this) {
								...
								if(sel1 != undefined) {
									...
									while(_g20 < _g110.length) {
										...
										if(old4 != cur8) {
											if(!cur8 && snabbdom_Attributes.booleanAttrsDict[key12]) elm11.removeAttribute(key12); else elm11.setAttribute(key12,cur8);
										}
									}
									var _g23 = 0;
		...
		var i15;
		var hook1;
		if((i15 = vnode6.data) != undefined && (hook1 = i15.hook) != undefined && (i15 = hook1.prepatch) != undefined) i15(oldVnode4,vnode6);
		if((i15 = oldVnode4.data) != undefined && (i15 = i15.vnode) != undefined) oldVnode4 = i15;
		if((i15 = vnode6.data) != undefined && (i15 = i15.vnode) != undefined) vnode6 = i15;
		var elm17 = vnode6.elm = oldVnode4.elm;
		var oldCh1 = oldVnode4.children;
		var ch2 = vnode6.children;
		if(oldVnode4 == vnode6) null; else {
			if(vnode6.data != undefined) {
				var key16;
				var cur12;
				var old6;
				var elm18 = vnode6.elm;
				var oldAttrs3 = oldVnode4.data.attrs == null?{ }:oldVnode4.data.attrs;
				var attrs3 = vnode6.data.attrs == null?{ }:vnode6.data.attrs;
				var _g30 = 0;
				var _g117 = Object.keys(attrs3);
				while(_g30 < _g117.length) {
					...
					if(old6 != cur12) {
						if(!cur12 && snabbdom_Attributes.booleanAttrsDict[key17]) elm18.removeAttribute(key17); else elm18.setAttribute(key17,cur12);
					}
				}
				var _g34 = 0;
				var _g118 = Object.keys(oldAttrs3);
				...
				var cur13;
				var old7;
				var elm19 = vnode6.elm;
				var oldProps3 = oldVnode4.data.props == null?{ }:oldVnode4.data.props;
				var props4 = vnode6.data.props == null?{ }:vnode6.data.props;
				var _g35 = 0;
				var _g119 = Object.keys(props4);
				while(_g35 < _g119.length) {
				...
				var cur14;
				var name19;
				var elm20 = vnode6.elm;
				var oldClass3 = oldVnode4.data.classes == null?{ }:oldVnode4.data.classes;
				var klass3 = vnode6.data.classes == null?{ }:vnode6.data.classes;
				var _g36 = 0;
				var _g120 = Object.keys(klass3);
				while(_g36 < _g120.length) {
					var name20 = _g120[_g36];
				...
				var style5 = vnode6.data.style == null?{ }:vnode6.data.style;
				var oldHasDel3 = Object.prototype.hasOwnProperty.call(oldStyle3,"delayed");
				var _g37 = 0;
				var _g121 = Object.keys(style5);
				while(_g37 < _g121.length) {
				...
				i15 = vnode6.data.hook;
				if(i15 != undefined && (i15 = i15.update) != undefined) i15(oldVnode4,vnode6);
			}
			if(vnode6.text == undefined) {
				if(oldCh1 != undefined && ch2 != undefined) {
					if(oldCh1 != ch2) snabbdom_Patch.updateChildren(elm17,oldCh1,ch2,insertedVnodeQueue);
				} else if(ch2 != undefined) {
					var vnodes2 = ch2;
					var startIdx2 = 0;
					var endIdx2 = ch2.length - 1;
					...
					if(startIdx2 <= endIdx2) do {
						new_node3 = (function($this) {
							...
							if(data3 != undefined) {
								if((i19 = data3.hook) != undefined && (i19 = i19.init) != undefined) i19(vnode7);
								if((i19 = data3.vnode) != undefined) vnode7 = i19;
							}
							var elm22;
							var children2 = vnode7.children;
							var sel2 = vnode7.sel;
							if(sel2 != undefined) {
								var hashIdx2 = sel2.indexOf("#",0);
								var dotIdx2 = sel2.indexOf(".",hashIdx2);
								...
								var dot2 = dotIdx2 > 0?dotIdx2:sel2.length;
								var tag2 = hashIdx2 != -1 || dotIdx2 != -1?sel2.slice(0,Math.min(hash2,dot2)):sel2;
								elm22 = vnode7.elm = data3 != undefined && (i19 = data3.ns) != undefined?document.createElementNS(i19,tag2):document.createElement(tag2);
								if(hash2 < dot2) elm22.id = sel2.slice(hash2 + 1,dot2);
								if(dotIdx2 > 0) {
									elm.className = sel.slice(dot+1).replace(snabbdom_Patch.rg, " ");;
								}
								if(Array.isArray(children2)) {
									i19 = 0;
									if(i19 < children2.length) do {
										var new_node4 = snabbdom_Patch.createElm(children2[i19],insertedVnodeQueue);
										elm22.appendChild(new_node4);
									} while((function($this) {
										var $r;
										++i19;
										$r = i19 < children2.length;
										return $r;
									}($this)));
								...
								while(_g39 < _g122.length) {
									...
									if(old8 != cur16) {
										if(!cur16 && snabbdom_Attributes.booleanAttrsDict[key22]) elm23.removeAttribute(key22); else elm23.setAttribute(key22,cur16);
									}
								}
								var _g40 = 0;
								...
								if(vnode7.data != null) {
									i19 = vnode7.data.hook;
									if(i19 != undefined) {
										if(i19.create) i19.create(snabbdom_Patch.emptyNode,vnode7);
										if(i19.insert) insertedVnodeQueue.push(vnode7);
									}
								}
						...
						elm17.insertBefore(new_node3,null);
					} while((function($this) {
						var $r;
						++startIdx2;
						$r = startIdx2 <= endIdx2;
					...
					if(startIdx3 <= endIdx3) do {
						...
						if(ch3 != undefined) {
							if(ch3.sel != undefined) {
								...
								var j1;
								if(i23 != undefined) {
									if((i23 = i23.hook) != undefined && (i23 = i23.destroy) != undefined) i23(vnode8);
									var style7 = null;
									var name29;
									var elm27 = vnode8.elm;
									...
									if((i23 = vnode8.children) != undefined) {
										j1 = 0;
										if(j1 < vnode8.children.length) do snabbdom_Patch.invokeDestroyHook(vnode8.children[j1]); while((function($this) {
											var $r;
											++j1;
								...
								if(!s3 || !s3.remove) {
									...
									var i25;
									i25 = 0;
									if(i25 < props6.length) do if(HxOverrides.indexOf(applied1,props6[i25],0) != -1) amount1[0]++; while((function($this) {
										var $r;
										++i25;
										$r = i25 < props6.length;
										return $r;
								...
								if((i22 = ch3.data) != undefined && (i22 = i22.hook) != undefined && (i22 = i22.remove) != undefined) i22(ch3,rm3); else rm3();
							} else elm17.removeChild(ch3.elm);
						}
					} while((function($this) {
						var $r;
						++startIdx3;
			...
			} else if(oldVnode4.text != vnode6.text) elm17.textContent = vnode6.text;
			if(hook1 != undefined && (i15 = hook1.postpatch) != undefined) i15(oldVnode4,vnode6);
		}
	}
	i = 0;
...
if(Array.prototype.indexOf) HxOverrides.indexOf = function(a,o,i) {
    ...
    ;
snabbdom_Attributes.booleanAttrs = ["allowfullscreen","async","autofocus","autoplay","checked","compact","controls","declare","default","defaultchecked","defaultmuted","defaultselected","defer","disabled","draggable","enabled","formnovalidate","hidden","indeterminate","inert","ismap","itemscope","loop","multiple","muted","nohref","noresize","noshade","novalidate","nowrap","open","pauseonexit","readonly","required","reversed","scoped","seamless","selected","sortable","spellcheck","translate","truespeed","typemustmatch","visible"];
snabbdom_Attributes.booleanAttrsDict = (function($this) {
	var $r;
	var hash = { };
	var len = snabbdom_Attributes.booleanAttrs.length;
	var i = 0;
	{
		i = 0;
		if(i < len) do hash[snabbdom_Attributes.booleanAttrs[i]] = true; while((function($this) {
			var $r;
			i++;
			$r = i < len;
			return $r;
